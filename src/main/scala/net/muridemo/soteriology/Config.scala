...
object Config {
  ...
  private val LOOK_RANGE: ForgeConfigSpec.DoubleValue = BUILDER
    ...
    .defineInRange("lookRange", 256.0, 0.0, 10000.0)
  ...
  private val ITEM_STRINGS: ForgeConfigSpec.ConfigValue[java.util.List[String]] = BUILDER
    .comment("A list of items to log on common setup.")
    .defineListAllowEmpty("items", java.util.List.of("minecraft:iron_ingot"), this.validateItemName)
    .asInstanceOf[ForgeConfigSpec.ConfigValue[java.util.List[String]]] // safe because String is final
